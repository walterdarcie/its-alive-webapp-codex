...
type RockHandSvgProps = {
  size?: number;
  className?: string;
};

export function RockHandSvg({ size = 22, className }: RockHandSvgProps) {
  const width = size * (61 / 91);
  return (
    <svg
      width={width}
      height={size}
    ...
    >
      <path
        d="M21.4219 34.7381V52.9961C21.4219 58.0039 10.4609 58.0547 10.4609 50.2461L10.457 37.4881C10.457 29.6873 21.4219 29.7108 21.4219 34.7381Z"
        fill="currentColor"
      />
      <path
        d="M35.5118 35.4142V37.8556C32.6056 38.8322 29.8126 40.1095 27.168 41.6564H27.1719C26.1055 42.2736 25.2031 43.1408 24.5469 44.1798V32.6568C24.5469 27.6568 35.5118 27.6095 35.5118 35.4142Z"
        fill="currentColor"
      />
      <path
        d="M48.0351 6.21417V36.1792C44.9101 35.851 41.6523 36.2182 38.6328 36.9487V35.4135C38.6328 32.4447 37.4219 29.9291 35.5078 28.3119L35.5117 6.2139C35.5117 -2.0713 48.0351 -2.07103 48.0351 6.21417Z"
        fill="currentColor"
      />
      <path
        d="M44.1681 85.7612V90.6245H8.2031V85.2183C8.2031 73.7803 0 65.1873 0 53.7493V15.2023C0 7.95227 10.453 7.95227 10.453 15.2023V30.3903C8.578 31.9684 7.328 34.4684 7.328 37.488V50.246C7.328 55.7929 11.5116 59.5858 16.7147 59.5858C19.8397 59.5858 22.5428 58.1952 24.1561 56.121H24.1522C26.328 57.414 28.91 57.8319 31.3788 57.2929C32.5311 57.6483 33.7108 57.8827 34.91 57.9921C32.2498 60.9335 30.4139 64.5233 29.5819 68.3981C29.4139 69.2379 29.9491 70.0583 30.785 70.2379C31.6209 70.4176 32.4491 69.8902 32.6366 69.0543C33.3827 65.5855 35.0624 62.3824 37.4999 59.8004C39.9374 57.2184 43.0351 55.3512 46.4569 54.4059C47.2889 54.1754 47.7772 53.3161 47.5467 52.484C47.3162 51.6519 46.4529 51.1637 45.6209 51.3942C43.0037 52.1247 40.5428 53.3122 38.3475 54.9098C35.2694 55.152 31.9413 54.6832 29.4022 52.9254C24.8319 49.8629 26.3163 45.7848 28.7381 44.3707C40.0931 37.7574 54.7381 36.0113 59.5431 48.191C65.1642 62.476 44.1681 76.7852 44.1681 85.7612Z"
        fill="currentColor"
      />
    </svg>
  );
